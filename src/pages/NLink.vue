<template>
  <Layout>
    ...
    <div v-else class="my-12"><a href="https://github.com/lights0123/n-link/releases/latest" target="_blank"
                                 rel="noopener" class="px-4 py-6 bg-blue-700 text-white">
      Download on GitHub
    </a></div>
    ...
    <ul>
      ...
      <li><p>
        Creating top-level directories: blocked by
        <a href="https://github.com/Vogtinator/libnspire/issues/2" target="_blank"
